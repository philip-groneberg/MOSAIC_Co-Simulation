...
"""
Script to modify automatically vtypes to carla type ids in mosaic route files.
"""
...
def main(route_files, vtypes, _random=False):
    """
    Main method to automatically modify vtypes to carla type ids in mosaic route files.
    """
